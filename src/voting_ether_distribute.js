...
(async () => {
  ...
  for(let i=1; i<9; i++)  {
    await web3.eth.sendTransaction({from:accounts[0], to:accounts[i], value:toWei("0.2")});
  }
  //await web3.eth.sendTransaction({from:accounts[0], to:"0xb6762AEc2b3cD39d31651CB48F38D1Cd4FDaFb8B", value:toWei("0.1")});
